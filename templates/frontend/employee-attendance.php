                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="attendance_status[]" class="ems-attendance-status">
                                        <option value="present" <?php selected($attendance_records[$employee->id]->status ?? '', 'present'); ?>><?php _e('Present', 'employee-management-system'); ?></option>
										<option value="absent" <?php selected($attendance_records[$employee->id]->status ?? '', 'absent'); ?>><?php _e('Absent', 'employee-management-system'); ?></option>
										<option value="half_day" <?php selected($attendance_records[$employee->id]->status ?? '', 'half_day'); ?>><?php _e('Half Day', 'employee-management-system'); ?></option>
										<option value="leave" <?php selected($attendance_records[$employee->id]->status ?? '', 'leave'); ?>><?php _e('Leave', 'employee-management-system'); ?></option>
